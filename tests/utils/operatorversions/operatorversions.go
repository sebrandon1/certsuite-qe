...
// cockroachdb-certified is NOT available in 4.20, so we use an alternative certified operator
//
...
//
// Alternative certified operators that could work:
//   - mongodb-enterprise: MongoDB Enterprise operator
//   - redis-enterprise: Redis Enterprise operator
//   - crunchy-postgres-operator: Crunchy Postgres for Kubernetes
//
// We use mongodb-enterprise as it's a well-established certified operator that's
// typically available across OCP versions.
...
// e.g., "4.20.0-0.nightly-2024-12-16" -> "4.20"
